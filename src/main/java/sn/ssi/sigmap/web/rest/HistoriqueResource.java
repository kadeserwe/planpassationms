...
public class HistoriqueResource {
    ...
    public ResponseEntity<HistoriqueDTO> updateHistorique(@Valid @RequestBody HistoriqueDTO historiqueDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<HistoriqueDTO>> getAllHistoriques(Pageable pageable) {
        log.debug("REST request to get a page of Historiques");
        Page<HistoriqueDTO> page = historiqueService.findAll(pageable);
